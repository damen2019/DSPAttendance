...
public class DspBranchesFragment extends Fragment {
    private FragmentDspBranchesBinding binding;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding = FragmentDspBranchesBinding.inflate(inflater, container, false);
